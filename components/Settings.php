...
namespace mmarouf\settings\components;
...
class Settings extends Component
{
     ...
     */
    public $modelClass = 'mmarouf\settings\models\BaseSetting';

    /**
     * Model to for storing and retrieving settings
     * @var \mmarouf\settings\models\SettingInterface
     */
    protected $model;
     ...
     */
    public $cacheKey = 'mmarouf/settings';
